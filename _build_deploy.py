...
checks={
 ...
 'fotos F2b: exclusao simples diz onde ficam as fotos; cartao diz que e o comprovante':'As fotos dele (se houver) ficam guardadas na nuvem' in chk and "📷 fotos da ${m.notaId?'nota':m.vendaId?'venda':'troca'} (comprovante)" in chk,
