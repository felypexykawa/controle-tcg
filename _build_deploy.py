...
checks={
 ...
 'fotos F2b: exclusao simples diz onde ficam as fotos; cartao diz que e o comprovante':('As fotos dele (se houver) ficam guardadas na nuvem' in chk or 'As fotos dele (se houver) ficam guardadas por 120 dias' in chk) and "📷 fotos da ${m.notaId?'nota':m.vendaId?'venda':'troca'} (comprovante)" in chk,
 ...
 'fotos F5a: IDB sobe para v2 com os stores fila e rascunho (upgrade so cria o que falta)':"indexedDB.open('tcg_fotos',2)" in chk and "createObjectStore('fila',{keyPath:'qid'})" in chk and "createObjectStore('rascunho',{keyPath:'id'})" in chk and 'rq.onblocked=()=>cb(null);' in chk,
 ...
 'fotos F5a: medidor de espaco no Backup (documento em bytes + fotos por fora) e texto honesto dos 120 dias':'function medirDocBytes()' in chk and 'function medirFotosNuvem(el)' in chk and 'Espaço na nuvem — documento principal' in chk and 'medir o espaço das fotos' in chk and 'ficam guardadas por 120 dias' in chk and "_fotosFalhadas.some(f=>f.enviando||!f.salva)" in chk,
 ...
 'fotos F5b: exclusao diz a verdade (120 dias + restauracao depende de ponto salvo, 12 na nuvem)':'os 12 mais recentes na nuvem' in chk and 'o prazo em que dá pra restaurar' not in chk,
