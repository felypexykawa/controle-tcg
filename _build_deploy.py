...
checks={
 ...
 'diario: gestos de criar/pagar/desfazer/separar/juntar/restaurar/mover registram quem fez':"diarioReg('lançou',rotDe(obj)" in chk and "diarioReg('editou',rotDe(movs[i])" in chk and "diarioReg('lançou nota de compra'" in chk and "diarioReg('vendeu (vários)'" in chk and "diarioReg('registrou troca'" in chk and "diarioReg('editou troca'" in chk and "diarioReg('marcou pago'" in chk and "diarioReg('desfez nota'" in chk and "diarioReg('separou da nota'" in chk and "diarioReg('juntou em nota'" in chk and "diarioReg('juntou notas'" in chk and "diarioReg('restaurou backup local'" in chk and "diarioReg('restaurou ponto da nuvem'" in chk and "diarioReg('moveu foto'" in chk,
