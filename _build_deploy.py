...
checks={
 ...
 'sem internet: lancamento local sobrevive ao snapshot do outro aparelho (pendencia + fusao, F0 22/08)':'function marcaPendNuvem' in chk and 'function fundirComRemoto' in chk and 'if(pendNuvem()){' in chk and "localStorage.getItem('tcg_pend_nuvem')==='1')_pendSeq=1" in chk and 'limpaPendNuvem(seqCap)' in chk and chk.count('marcaPendNuvem();if(_syncReady)salvarNuvem();')>=3,
